...
STATIC_URL = '/static/'
# ищет дополнительную статику в приложениях при запуске сервера django
...
# путь к папке где после выполнения, collectstatic, будет собрана вся статика, из всех приложений и админки
...
"""
Для работы со статическими файлами в Django:
нужно прописать в settings.py

Константа которая определяет где Django ищет статику в приложениях при запуске сервера
STATICFILES_DIRS = [
